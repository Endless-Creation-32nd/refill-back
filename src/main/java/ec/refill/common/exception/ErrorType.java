...
public enum ErrorType {
  ...
  */
  ...
  ALREADY_BOOK_MARK("E027", HttpStatus.CONFLICT),
  NOT_PENALTY_GROUP("E028",HttpStatus.CONFLICT),
  LIMIT_PENALTY("E029", HttpStatus.CONFLICT),
  NOT_SATISFIED_PENALTY_POLICY("E030", HttpStatus.CONFLICT),
  NOT_ALLOW_ADMIN_REQUEST("E031",HttpStatus.CONFLICT),
  //500
